...
public class BookCab extends JFrame{  //Forth
    ...
    JTable table;
    JLabel ReservationDetails,Source,Destination,selectuser;
    JButton show, b1, b2;
    Choice c1, c2,c3;
    ...
    selectuser =new JLabel("Select User.");
        selectuser.setFont(new Font("Tahoma", Font.PLAIN, 19));
        selectuser.setBounds(60, 60, 120, 27);
        add(selectuser);
	...
	show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String username=c3.getSelectedItem();
                ...
                if(rs2.next()){
                          l10.setText(rs2.getString("name"));
                          l12.setText(rs2.getString("username"));
                }
